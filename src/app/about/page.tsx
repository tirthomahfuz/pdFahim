        ...
        <div className="container mx-auto px-4 py-12 max-w-3xl flex-1">
            ...
            <div className="space-y-8">
                ...
                <div className="prose prose-neutral dark:prose-invert max-w-none">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-6">
                        What makes pdFahim different is its architecture. All PDF manipulation—whether merging, splitting, compressing, or converting—happens entirely within your internet browser using modern WebAssembly and JavaScript technologies.
                        <br className="mb-2" />
                        <strong>Your files are never uploaded to our servers.</strong> This guarantees absolute privacy and allows the tools to work even if you lose your internet connection after the page loads.
                    </p>
                ...
                <div className="bg-muted/30 rounded-2xl p-6 border flex flex-col sm:flex-row items-center justify-between gap-6 mt-12">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Check out the GitHub repository to see how it's built.</p>
                    </div>
                    <Button asChild>
                        <a href="https://github.com/shahriyar/pdFahim" target="_blank" rel="noreferrer">
